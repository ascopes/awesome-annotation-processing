...
* https://github.com/ascopes/java-compiler-testing[Java Compiler Testing] - A Java API for writing annotation processor integration tests, with a focus on module support and a fluent, reusable API.
